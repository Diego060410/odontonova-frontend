...
export default function PerfilOdontologo() {
  ...
  // ── Módulos de navegación (Odontólogo) ──
  const navModules = [
    { to: "/odontologo/mis-citas", label: "Mis Citas", icon: <CalendarIcon /> },
    { to: "/odontologo/horario", label: "Mi Horario", icon: <ClockIcon /> },
    { to: "/odontologo/citas-atendidas", label: "Historial", icon: <HistoryIcon /> },
    { to: "/odontologo/pacientes", label: "Mis Pacientes", icon: <UsersIcon /> },
    { to: "/odontologo/perfil", label: "Mi Perfil", icon: <ProfileIcon /> },
  ];

  // ── Acciones rápidas ──
  const quickActions = [
    { to: "/odontologo/nuevo-horario", label: "Agregar Horario", accent: "#059669" },
    { to: "/odontologo/nueva-cita", label: "Nueva Cita", accent: "#1e40af" },
    { to: "/odontologo/notas", label: "Notas Clínicas", accent: "#7c3aed" },
  ];
  ...
  return (
    <>
      ...
      <div className="perfil-root">
        {/* ── TOPBAR CONSISTENTE CON DASHBOARD ── */}
        <header className="perfil-topbar">
          <div className="topbar-brand" onClick={() => navigate("/odontologo/dashboard")}>
          ...
          <nav className="topbar-nav">
            ...
            <Link to="/odontologo/perfil" className="btn-action btn-profile">Perfil</Link>
        ...
        <main className="perfil-content">
          ...
          <div className="perfil-card">
            ...
            <div className="perfil-header-card">
              <div className="perfil-avatar" aria-label="Avatar de odontólogo">
              ...
              <div className="perfil-info">
                ...
                <p>Odontólogo certificado OdontoNova</p>
