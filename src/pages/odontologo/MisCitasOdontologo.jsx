...
export default function MisCitasOdontologo() {
  ...
  const cargarCitas = async () => {
    try {
      ...
      activas.sort((a, b) =>
        new Date(`${a.fecha}T${a.horaInicio}`) - new Date(`${b.fecha}T${b.horaInicio}`)
      );
  ...
  const estadoStyle = (estado) => {
    const map = {
      ...
      ATENDIDO:   { bg: "#eff6ff", color: "#1e40af", border: "#93c5fd", text: "Atendida" },
      EN_ESPERA:  { bg: "#f5f3ff", color: "#7c3aed", border: "#c4b5fd", text: "En espera" },
    };
    const key = estado?.toUpperCase() || "PENDIENTE";
    return map[key] || { bg: "#f8fafc", color: "#475569", border: "#e2e8f0", text: estado || "Pendiente" };
  };
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* Lista de citas estilo activity-card */
        ...
        <main className="dash-content">
          <div className="page-header">
            <div>
              ...
              <p className="page-subtitle">Consulta tu agenda de pacientes</p>
            </div>
          ...
          {citas.length === 0 ? (
            <div className="empty-state">
              ...
              <p className="empty-state-title">Sin citas activas</p>
              <p className="empty-state-text">No tienes citas programadas en este momento.</p>
            </div>
          ) : (
                  ...
                  <div className="cita-card" key={c.idCita}>
                    <div className="cita-header">
                      <div className="cita-paciente">
                        ...
                        {c.paciente?.nombres || "Paciente registrado"}
                      </div>
