...
export default function PerfilPaciente() {
  ...
  const handleGuardar = async (e) => {
    ...
    try {
      const payload = {
        ...
        estado: true,
        // ⚠️ Solo enviamos password si el usuario escribió algo nuevo
  ...
  // ── Módulos de navegación (Paciente) ──
  const navModules = [
    { to: "/paciente/mis-citas", label: "Mis Citas", icon: <CalendarIcon /> },
    { to: "/paciente/perfil", label: "Mi Perfil", icon: <ProfileIcon /> },
  ];

  // ── Acciones rápidas ──
  const quickActions = [
    { to: "/paciente/nueva-cita", label: "Agendar Cita", accent: "#1e40af" },
    { to: "/paciente/mis-citas", label: "Mis Citas", accent: "#059669" },
  ...
  function HistoryIcon() { return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"/><path d="M12 7v5l4 2"/></svg>; }
  ...
  function ToothIcon() { return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 2C9 2 7 4 7 7c0 2 1 4 2 6-1 2-2 4-2 6 0 2 2 3 5 3s5-1 5-3c0-2-1-4-2-6 1-2 2-4 2-6 0-3-2-5-5-5z"/><circle cx="12" cy="9" r="2"/></svg>; }
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .perfil-avatar{width:80px;height:80px;border-radius:50%;background:linear-gradient(135deg,var(--primary-100),var(--primary-50));display:flex;align-items:center;justify-content:center;font-size:2rem;flex-shrink:0;box-shadow:0 4px 20px rgba(30,64,175,0.15);border:3px solid var(--surface);color:var(--primary-600)}
      ...
      <div className="perfil-root">
        ...
        <header className="perfil-topbar">
          <div className="topbar-brand" onClick={() => navigate("/paciente/dashboard")}>
          ...
          <nav className="topbar-nav">
            ...
            <Link to="/paciente/perfil" className="btn-action btn-profile">Perfil</Link>
        ...
        <main className="perfil-content">
          <div className="perfil-header">
            <div className="perfil-title-group">
              <p className="perfil-eyebrow">Cuenta & Salud</p>
          ...
          <div className="perfil-card">
            ...
            <div className="perfil-header-card">
              <div className="perfil-avatar" aria-label="Avatar de paciente">
                <ToothIcon />
              </div>
              <div className="perfil-info">
                <h2>{perfil.nombres} {perfil.apellidos}</h2>
                <p>Paciente registrado en OdontoNova</p>
